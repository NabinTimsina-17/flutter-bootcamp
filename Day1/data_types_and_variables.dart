void main(){
  // data type - those pre building data types that represents data what kind of data it is
  // Generally, in dart there are 7 building data types. They are as follows:
  int age = 18;
